...
class FoodBox extends Component {
    ...
    handleChange = event => {
        ...
        if(value < 0) return; //se for um número menor do que zero, não vai deixar fazer
    ...
    handleUpdateCart = () => {
        ...
        updateCart({...food, quantity: +this.state.quantity}); //estou mantendo o objeto do jeito que está e só atualizando quantidade
    }
